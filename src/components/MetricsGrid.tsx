        ...
        >
          ...
          <div className="relative flex items-center justify-center mt-9 pb-1">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span 
                className={`text-[22px] font-semibold tracking-tight ${hasScans ? "text-[#1c1c1e]" : "text-zinc-300"}`}
        ...
        {showMedsSheet && (
          <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-50 flex items-end justify-center">
            ...
            <motion.div
              ...
              className="w-full max-w-md bg-white rounded-t-[2.5rem] p-6 shadow-2xl relative z-10 flex flex-col max-h-[85vh]"
